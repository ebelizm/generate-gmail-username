...
print("Generate gmail 5 character random username")
qty = input("How many: ")
print(" ")
...
while i < int(qty):
    ...
    print(f"{i}| {username}@gmail.com:  {stats}")
    # if not isValid:
    #     print(f"sugestions : {sugestions}@gmail.com")


print("\nDone!", qty,"random username has been generated","\nAvailable username saved in gmail.txt\nHope you find a nice one")
